    ...
    <section className='pt-5 lg:pt-14 lg:pb-5 text-primary'>
      <Container>
        <div className='max-w-[1180px] mx-auto lg:text-center'>
          ...
          <Animate as='h2' className='h2 leading-[1.2] py-7 lg:py-14 text-center ff-2'>ACCEPT A THREE-DAY CHALLENGE FOR OFFERING TAHAJJUD NAMAZ WITH US AND WITNESS YOUR LIFE CHANGE FOR THE BEST</Animate>
        </div>
      </Container>
    </section>
  )
